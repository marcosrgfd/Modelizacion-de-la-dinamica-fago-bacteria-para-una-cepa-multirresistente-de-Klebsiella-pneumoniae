...
Representación de series temporales con modificación individual de cada parámetro mantiendo constante el resto en valores arbitrarios:
...
combos <- function(param, sec, titulo) {
  ...
  param.name <- param # Parámetro a modificar
